...
>
> Conduct a comprehensive code review per your standard categories. Cross-check against [CLAUDE.md](CLAUDE.md) and any `.claude/rules/*.md` whose `paths:` globs match the diff paths — project conventions and area gotchas matter. Report findings in the standard format (numbered list of categorized findings with concrete file:line references, then a one-line verdict).
>
